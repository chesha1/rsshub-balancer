/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config apps/server/wrangler.jsonc --env-interface CloudflareBindings apps/server/worker-configuration.d.ts` (hash: a773641be8623e534d0867059abbe1b5)
// Runtime types generated with workerd@1.20260415.1 2026-03-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RequestCoalescer";
	}
	interface Env {
		KV: KVNamespace;
		...
		DO: DurableObjectNamespace<import("./src/index").RequestCoalescer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STATE_STORE_BACKEND" | "VALKEY_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ANALYTICS_API_TOKEN">> {}
}
