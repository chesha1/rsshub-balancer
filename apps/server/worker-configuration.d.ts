/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config apps/server/wrangler.jsonc --env-interface CloudflareBindings apps/server/worker-configuration.d.ts` (hash: 237126257d892a8a4d0c3e0130d2bdb0)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STATE_STORE_BACKEND">> {}
}
