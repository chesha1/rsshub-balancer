/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/server/wrangler.jsonc --env-interface=CloudflareBindings apps/server/worker-configuration.d.ts` (hash: e9933599aa6303eac2118262d590e15a)
