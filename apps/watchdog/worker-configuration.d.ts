/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=WatchdogBindings` (hash: ed39f3b55faa7c68154f6007f18ee80d)
// Runtime types generated with workerd@1.20260916.1 2026-09-23 global_fetch_strictly_public
interface __BaseEnv_WatchdogBindings {
	CLOUDFLARE_ZONE_ID: string;
	CLOUDFLARE_ROUTES_API_TOKEN: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_WatchdogBindings {}
}
interface WatchdogBindings extends __BaseEnv_WatchdogBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ZONE_ID" | "CLOUDFLARE_ROUTES_API_TOKEN">> {}
}
