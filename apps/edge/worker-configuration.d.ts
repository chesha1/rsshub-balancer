/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=EdgeBindings` (hash: d920e3f5ae562713f576c7ab918e7416)
// Runtime types generated with workerd@1.20260916.1 2026-09-17 new_module_registry,nodejs_compat
interface __BaseEnv_EdgeBindings {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_EdgeBindings {}
}
interface EdgeBindings extends __BaseEnv_EdgeBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALKEY_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ANALYTICS_API_TOKEN">> {}
}
